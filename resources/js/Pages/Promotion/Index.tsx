            ...
            <div className="py-8 bg-slate-50 min-h-[calc(100vh-81px)]">
                <div className="w-full max-w-none mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-12 text-center">
                        ...
                        <h3 className="mt-6 text-xl font-black text-slate-900">Promotion & Transfer Module Activated</h3>
                        <p className="mt-2 text-sm text-slate-500 max-w-sm mx-auto">
                            Handle student promotions, graduations, and external transfers.
                        </p>
                        <div className="mt-8">
